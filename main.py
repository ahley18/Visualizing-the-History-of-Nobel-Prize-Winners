...
print('Decade with Highest proportion of US-born winners: ' + str(max_decade_usa))
...
print("Highest Female Proportion (Decade and Category): " + str(max_female_dict))
...
print('First Woman Winner: ' + str(first_woman_name))

first_woman_category = nobel[nobel['sex'] == 'Female']['category'].values[0]
print('First Woman Winner(Category): ' + str(first_woman_category))
...
print('Multiple Wins: ' + repeat_list)
